...
function passRecover(to, hash, callback){
    mail({
        ...
        html: "<h2>GAME - UPV mail verification</h2><p>Este correo ha sido enviado para la recuperacion de la cuenta.</p><p>Si usted ha pedido la recuperacion de la cuenta asociada a este email, entre en el siguiente enlace antes de 24 horas.</p><a href='https://176.84.122.148:4433/forgotenPass?hash="+hash+"&email="+to+"'>ENLACE</a>",
        from: 'gameupv@gmail.com',
        to: to
    }, callback);
}
